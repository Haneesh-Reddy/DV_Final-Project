...
d3.csv('https://raw.githubusercontent.com/Haneesh-Reddy/Activity-7_Datasets/main/slim-3.csv').then(codes2 => {
...
d3.json('https://unpkg.com/world-atlas@1.1.4/world/110m.json').then(world2 => {
    ...
    /////// New vaccines ///////
    d3.csv('https://raw.githubusercontent.com/Haneesh-Reddy/Activity-7_Datasets/main/VaccinationPour100.000V4.csv').then(vaccin => {
        ...
        d3.csv("https://raw.githubusercontent.com/Haneesh-Reddy/Activity-7_Datasets/main/VaccinationPour100.000.csv", prepare2, function (vaccin) {
            dataset2 = vaccin;
            playButton2
                .on("click", function () {
