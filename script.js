...
d3.csv('https://raw.githubusercontent.com/Haneesh-Reddy/Activity-7_Datasets/main/slim-3.csv').then(codes => {
...
d3.json('https://unpkg.com/world-atlas@1.1.4/world/110m.json').then(world => {
    ...
    /////// New covid cases ///////
    d3.csv('https://raw.githubusercontent.com/Haneesh-Reddy/Activity-7_Datasets/main/NewCasPour100.000V4.csv').then(data => {
        ...
        d3.csv("https://raw.githubusercontent.com/Haneesh-Reddy/Activity-7_Datasets/main/NewCasPour100.000.csv", prepare, function (data) {
            dataset = data;
            playButton
                .on("click", function () {
